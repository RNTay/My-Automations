...
def create_pdf_and_get_text(local_filename):
    try:
...
if __name__ == '__main__':
    ...
    page_with_grand_total_text = create_pdf_and_get_text(securities)
    Vol, Val = output_grand_total(page_with_grand_total_text)
    pretty_print(Vol, Val)
